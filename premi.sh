...
TIMES="10"
CHATID="1181118730"
KEY="6938101552:AAEqZbb3CSXLp91brJLGnRqPAbUMjtvWCyA"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To DijeTunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}dije® ${NC}${YELLOW}(${NC} ${green} DijeTunnel${NC}${YELLOW})${NC}"
echo -e " © Recode By My Dije Tunneling${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/dije77/Regist/MONSTER/afk | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/dije77/Regist/MONSTER/afk | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/dije77/Regist/MONSTER/afk | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/dije77/wiz4rd/MONSTER/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/dije77/Regist/MONSTER/afk | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/dije77/Regist/MONSTER/afk | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/dije77/wiz4rd/MONSTER/limit/limit.sh && chmod +x limit.sh && ./limit.sh
